...
func (r *productRepo) Create(p *domain.Product) error {
	...
	return r.db.QueryRowx(
		`INSERT INTO products (name, price, power, tempereture, type, lamp_cap, image_url, created_at, updated_at) values ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id`,
		p.Name, p.Price, p.Power, p.Temperature, p.Type, p.LampCap, p.ImageURL, p.CreatedAt,
		).Scan(&p.ID)
}
